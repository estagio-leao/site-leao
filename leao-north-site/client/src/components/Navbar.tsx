...
export default function Navbar({ variant = "dark", simple = false }: NavbarProps) {
  ...
  const ctaClass = `flex items-center justify-center gap-2 bg-[#F0B429] text-[#080808] font-['Barlow_Condensed'] font-700 text-sm uppercase tracking-wider rounded-sm hover:bg-[#FFD060] active:scale-[0.97] transition-all duration-200 ${
  ...
  return (
    ...
    >
      ...
      <nav className="container mx-auto px-4 lg:px-8 flex items-center justify-between h-16 lg:h-20">
        ...
        {/* CTA Button (WhatsApp em "simple"; âncora #contato na landing) */}
        {simple ? (
          <a
            href={WHATSAPP_URL}
            target="_blank"
      ...
      {/* Mobile Menu (somente fora do modo "simple") */}
      {!simple && (
        <div
